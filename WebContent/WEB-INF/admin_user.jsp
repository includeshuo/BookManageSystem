...
<%@ page import = "com.ys.bean.User,com.ys.dao.UserDao,com.ys.dao.impl.UserDaoImpl,com.ys.bean.User" %>
<!DOCTYPE HTML >
...
<button type="button" class="btn btn-danger btn-xs" onclick="deleteuser(<%= bean.getUserid() %>)">删除</button>
    ...
    function showInfo2(aid,username,profession,password) {
        ...
        document.getElementById("updatepro").value = profession;
    ...
    function deleteuser(aid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/BookManageSystem/DeleteUserServlet?aid="+aid;
    	}
    }
    </script>
									...
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">账号</label>
												<div class="col-sm-7">
													...
													<input type="text" class="form-control" id="updateaid" name="userid"  placeholder="">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">姓名</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatename" name="username"  placeholder="">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">专业</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatepro" name="profession" placeholder="">
