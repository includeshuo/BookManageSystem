...
<%@ page import = "com.ys.bean.BookHistory,com.ys.dao.UserDao,com.ys.dao.BookDao,com.ys.dao.impl.BookDaoImpl,com.ys.bean.User,com.ys.dao.UserDao,com.ys.dao.impl.UserDaoImpl" %>
<!DOCTYPE HTML >
                    ...
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                           ...
                           if(bookdata==null){
                        	   ...
                        	   bookdata = (ArrayList<BookHistory>)bookdao.get_HistoryListInfo2(0);
                           }
  ...
  %>                 
                             ...
                             <%} %> 
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="/BookManageSystem/updateBookManageSystemervlet">   <!--保证样式水平不混乱-->   
